...
const users2Name = users2.map((user2) =>
(user2.name.includes('A')) ? 'Anacleto' : user2.name);
...
const citiesName = cities.map((citie) =>
(citie.isVisited === true) ? `${citie.name } Visitado` :citie.name);
